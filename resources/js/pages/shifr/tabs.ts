import { Binary, Fingerprint, KeyRound, Link2, ShieldCheck } from 'lucide-vue-next';
...
export const SHIFR_TABS: ShifrTabDefinition[] = [
    ...
    { key: 'jwt', icon: ShieldCheck, labelKey: 'shifr.tabs.jwt', descriptionKey: 'shifr.descriptions.jwt', component: ShifrJwtTab },
];
