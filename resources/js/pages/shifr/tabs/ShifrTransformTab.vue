        ...
        >
            ...
            <label class="mt-3 block">
                <span
                    ...
                    >{{ t('shifr.transform.operation') }}</span
                >
                <select
                    v-model="operation"
                    class="h-10 w-full rounded-md border border-input bg-background px-3 text-sm"
                >
                    <option value="base64_encode">
                        {{ t('shifr.transform.base64Encode') }}
                    </option>
                    <option value="base64_decode">
                        {{ t('shifr.transform.base64Decode') }}
                    </option>
                    <option value="base64url_encode">
                        {{ t('shifr.transform.base64UrlEncode') }}
                    </option>
                    <option value="base64url_decode">
                        {{ t('shifr.transform.base64UrlDecode') }}
                    </option>
                    <option value="hex_encode">
                        {{ t('shifr.transform.hexEncode') }}
                    </option>
                    <option value="hex_decode">
                        {{ t('shifr.transform.hexDecode') }}
                    </option>
                    <option value="url_encode">
                        {{ t('shifr.transform.urlEncode') }}
                    </option>
                    <option value="url_decode">
                        {{ t('shifr.transform.urlDecode') }}
                    </option>
                    <option value="html_encode">
                        {{ t('shifr.transform.htmlEncode') }}
                    </option>
                    <option value="html_decode">
                        {{ t('shifr.transform.htmlDecode') }}
                    </option>
                </select>
            </label>
