...
defineProps<{ task: TrackingTask; busy: boolean }>();
defineEmits<{
...
<template>
    <article class="min-w-0 space-y-4 [overflow-wrap:anywhere]">
        ...
        <details class="rounded-lg border border-border/60 p-3">
            <summary class="cursor-pointer text-sm font-medium">
                {{ t('telegramTracking.details') }}
            </summary>
            <dl
