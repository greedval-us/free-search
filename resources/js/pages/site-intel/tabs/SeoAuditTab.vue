...
<template>
    <IntelSearchPanel>
        <div class="space-y-1">
            ...
            <p class="text-xs text-muted-foreground">
                {{ t('siteIntel.seoAudit.description') }}
            </p>
        </div>
        ...
        <IntelSearchFormComplex :error="error">
            ...
            <label class="block w-52">
                ...
                >
                    ...
                    <option value="generic">
                        {{ t('siteIntel.seoAudit.profile.generic') }}
                    </option>
                    <option value="media-platform">
                        {{ t('siteIntel.seoAudit.profile.media-platform') }}
                    </option>
                    <option value="content-site">
                        {{ t('siteIntel.seoAudit.profile.content-site') }}
                    </option>
                    <option value="storefront">
                        {{ t('siteIntel.seoAudit.profile.storefront') }}
                    </option>
                </select>
            </label>
            ...
            >
                ...
                <span>{{
                    loading
                        ? t('siteIntel.seoAudit.analyzing')
                        : t('siteIntel.seoAudit.analyze')
                }}</span>
            </button>
            <button
                type="button"
    ...
    <IntelResultPanel>
        ...
        <div
            v-else
            class="intel-scroll min-h-0 flex-1 space-y-3 overflow-y-auto pr-1 text-xs"
        >
            <div class="grid gap-2 sm:grid-cols-2 xl:grid-cols-4">
                ...
                >
                    <p class="text-muted-foreground">
                        {{ t('siteIntel.seoAudit.score') }}
                    </p>
                    <p class="mt-1 text-xl font-semibold" :class="scoreClass">
                        {{ result.score.value }}
                    </p>
                </div>
                <div
                ...
                >
                    <p class="text-muted-foreground">
                        {{ t('siteIntel.seoAudit.httpStatus') }}
                    </p>
                ...
                >
                    <p class="text-muted-foreground">
                        {{ t('siteIntel.seoAudit.ttfb') }}
                    </p>
                    <p class="mt-1 text-xl font-semibold">
                        {{ result.performance.ttfbMsApprox }} ms
                    </p>
                </div>
                <div
                    class="rounded-lg border border-border/70 bg-background/60 p-3"
            ...
            >
                <div class="mb-1 flex items-center gap-2">
                    <p class="text-muted-foreground">
                        {{ t('siteIntel.seoAudit.scoreProfile') }}
                    </p>
                    <span class="group relative inline-flex">
                        <span
                            class="inline-flex h-4 w-4 cursor-help items-center justify-center rounded-full border border-border text-[10px] font-semibold text-muted-foreground"
                ...
                <p class="mt-1 text-sm font-semibold">
                    {{
                        t(`siteIntel.seoAudit.profile.${result.score.profile}`)
                    }}
                </p>
            </div>
            ...
            >
                <p class="font-semibold">
                    {{ t('siteIntel.seoAudit.targetSummary') }}
                </p>
                <p class="mt-1">
                    {{ t('siteIntel.seoAudit.finalUrl') }}:
                    <span class="break-all text-muted-foreground">{{
                        result.target.finalUrl
                    }}</span>
                </p>
                <p class="mt-1">
                    {{ t('siteIntel.seoAudit.host') }}:
            ...
            <div class="grid gap-2 xl:grid-cols-2">
                ...
                >
                    <div class="mb-2 flex items-center gap-2">
                        <p class="font-semibold">
                            {{ t('siteIntel.seoAudit.metaTitle') }}
                        </p>
                        <span class="group relative inline-flex">
                            <span
                                class="inline-flex h-5 w-5 cursor-help items-center justify-center rounded-full border border-border text-[11px] font-semibold text-muted-foreground"
                    ...
                    <p>
                        {{ t('siteIntel.seoAudit.titleLength') }}:
                        <span class="text-muted-foreground">{{
                            result.meta.titleLength
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.descriptionLength') }}:
                        <span class="text-muted-foreground">{{
                            result.meta.descriptionLength
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.canonical') }}:
                        <span class="break-all text-muted-foreground">{{
                            result.meta.canonical || '-'
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.metaRobots') }}:
                        <span class="text-muted-foreground">{{
                            result.meta.robots || '-'
                        }}</span>
                    </p>
                ...
                >
                    <div class="mb-2 flex items-center gap-2">
                        <p class="font-semibold">
                            {{ t('siteIntel.seoAudit.indexabilityTitle') }}
                        </p>
                        <span class="group relative inline-flex">
                            <span
                                class="inline-flex h-5 w-5 cursor-help items-center justify-center rounded-full border border-border text-[11px] font-semibold text-muted-foreground"
                    ...
                    <p>
                        {{ t('siteIntel.seoAudit.indexable') }}:
                        <span class="text-muted-foreground">{{
                    ...
                    <p>
                        {{ t('siteIntel.seoAudit.xRobotsTag') }}:
                        <span class="text-muted-foreground">{{
                            result.indexability.xRobotsTag || '-'
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.reason') }}:
                        <span class="text-muted-foreground">{{
                            result.indexability.reason
                        }}</span>
                    </p>
                </div>
            </div>
            ...
            <div class="grid gap-2 xl:grid-cols-3">
                ...
                >
                    <p class="mb-2 font-semibold">
                        {{ t('siteIntel.seoAudit.headingsTitle') }}
                    </p>
                    <p>
                        H1:
                        <span class="text-muted-foreground">{{
                ...
                >
                    <p class="mb-2 font-semibold">
                        {{ t('siteIntel.seoAudit.linksTitle') }}
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.internalLinks') }}:
                        <span class="text-muted-foreground">{{
                            result.links.internal
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.externalLinks') }}:
                        <span class="text-muted-foreground">{{
                            result.links.external
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.nofollowLinks') }}:
                        <span class="text-muted-foreground">{{
                ...
                >
                    <div class="mb-2 flex items-center gap-2">
                        <p class="font-semibold">
                            {{ t('siteIntel.seoAudit.performanceTitle') }}
                        </p>
                        <span class="group relative inline-flex">
                            <span
                                class="inline-flex h-5 w-5 cursor-help items-center justify-center rounded-full border border-border text-[11px] font-semibold text-muted-foreground"
                    ...
                    <p>
                        {{ t('siteIntel.seoAudit.pageSize') }}:
                        <span class="text-muted-foreground"
                            >{{ result.performance.pageSizeKb }} KB</span
                        >
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.resourcesCount') }}:
                        <span class="text-muted-foreground">{{
                            result.performance.resourceCount
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.renderBlocking') }}:
                        <span class="text-muted-foreground">{{
                            result.performance.renderBlocking.total
                        }}</span>
                    </p>
                </div>
            </div>
            ...
            <div class="grid gap-2 xl:grid-cols-2">
                ...
                >
                    <p class="mb-2 font-semibold">
                        {{ t('siteIntel.seoAudit.recommendationsTitle') }}:
                        severity
                    </p>
                    <div class="space-y-2">
                        <div v-for="item in recommendationBars" :key="item.key">
                            ...
                            >
                                <span>{{
                                    t(`siteIntel.seoAudit.priority.${item.key}`)
                                }}</span>
                                <span>{{ item.value }}</span>
                            </div>
                            <div class="h-2 rounded bg-muted/50">
                                <div
                                    class="h-2 rounded bg-sky-400/80"
                ...
                >
                    ...
                    <div class="space-y-2">
                        <div v-for="item in crawlStatusBars" :key="item.key">
                            ...
                            <div class="h-2 rounded bg-muted/50">
                                <div
                                    class="h-2 rounded bg-emerald-400/80"
                                    :style="{ width: `${item.percent}%` }"
                                />
                            </div>
                        </div>
            ...
            <div class="grid gap-2 xl:grid-cols-3">
                ...
                >
                    <div class="mb-2 flex items-center gap-2">
                        <p class="font-semibold">
                            {{ t('siteIntel.seoAudit.crawlFilesTitle') }}
                        </p>
                        <span class="group relative inline-flex">
                            <span
                                class="inline-flex h-5 w-5 cursor-help items-center justify-center rounded-full border border-border text-[11px] font-semibold text-muted-foreground"
                    ...
                    <p>
                        {{ t('siteIntel.seoAudit.robotsTxt') }}:
                        <span class="text-muted-foreground"
                            >{{
                            ...
                            ({{ result.robots.status }})</span
                        >
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.sitemapXml') }}:
                        <span class="text-muted-foreground"
                            >{{
                                result.sitemap.available
                                    ? t('siteIntel.common.available')
                                    : t('siteIntel.common.missing')
                            }}
                            ({{ result.sitemap.status }})</span
                        >
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.sitemapEntries') }}:
                        <span class="text-muted-foreground">{{
                            result.sitemap.entries
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.robotsWildcard') }}:
                        <span class="text-muted-foreground">{{
                            result.robots.rules.hasWildcardGroup
                                ? t('siteIntel.common.yes')
                                : t('siteIntel.common.no')
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.robotsCrawlDelay') }}:
                        <span class="text-muted-foreground">{{
                            result.robots.rules.hasCrawlDelay
                                ? t('siteIntel.common.yes')
                                : t('siteIntel.common.no')
                        }}</span>
                    </p>
                ...
                >
                    <p class="mb-2 font-semibold">
                        {{ t('siteIntel.seoAudit.securityTitle') }}
                    </p>
                    <p>
                        HTTPS:
                        <span class="text-muted-foreground">{{
                    ...
                    <p>
                        {{ t('siteIntel.seoAudit.mixedContent') }}:
                        <span class="text-muted-foreground">{{
                            result.security.mixedContent
                                ? t('siteIntel.common.yes')
                                : t('siteIntel.common.no')
                        }}</span>
                    </p>
                ...
                >
                    <div class="mb-2 flex items-center gap-2">
                        <p class="font-semibold">
                            {{ t('siteIntel.seoAudit.technicalFlags') }}
                        </p>
                        <span class="group relative inline-flex">
                            <span
                                class="inline-flex h-5 w-5 cursor-help items-center justify-center rounded-full border border-border text-[11px] font-semibold text-muted-foreground"
                    ...
                    <p>
                        {{ t('siteIntel.seoAudit.mobileFriendly') }}:
                        <span class="text-muted-foreground">{{
                            result.mobileFriendly.isResponsive
                                ? t('siteIntel.common.yes')
                                : t('siteIntel.common.no')
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.pagination') }}:
                        <span class="text-muted-foreground">{{
                            result.pagination.isPaginated
                                ? t('siteIntel.common.yes')
                                : t('siteIntel.common.no')
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.soft404') }}:
                        <span class="text-muted-foreground">{{
                            result.soft404.detected
                                ? t('siteIntel.common.yes')
                                : t('siteIntel.common.no')
                        }}</span>
                    </p>
            ...
            >
                ...
                >
                    ...
                    <span
                        v-for="(signal, idx) in result.score.signals"
                        :key="signal"
                    >
                ...
                <ul class="list-disc space-y-1 pl-4 text-muted-foreground">
                    ...
                    >
                        [{{
                            t(`siteIntel.seoAudit.priority.${item.priority}`)
                        }}]
                        {{ t(`siteIntel.seoAudit.recommendation.${item.key}`) }}
                    </li>
                </ul>
            </div>
            ...
            <div class="grid gap-2 xl:grid-cols-3">
                ...
                >
                    <p class="mb-2 font-semibold">
                        {{ t('siteIntel.seoAudit.crawlTitle') }}
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.crawlScanned') }}:
                        <span class="text-muted-foreground"
                            >{{ result.crawl.scanned }}/{{
                                result.crawl.limit
                            }}</span
                        >
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.crawlPagesWithHreflang') }}:
                        <span class="text-muted-foreground">{{
                            result.crawl.hreflangAudit.pagesWithHreflang
                        }}</span>
                    </p>
                </div>
                <div
                ...
                >
                    <p class="mb-2 font-semibold">
                        {{ t('siteIntel.seoAudit.canonicalAuditTitle') }}
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.canonicalMissing') }}:
                        <span class="text-muted-foreground">{{
                            result.crawl.canonicalAudit.missing.length
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.canonicalCrossDomain') }}:
                        <span class="text-muted-foreground">{{
                            result.crawl.canonicalAudit.crossDomain.length
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.canonicalInvalid') }}:
                        <span class="text-muted-foreground">{{
                            result.crawl.canonicalAudit.invalid.length
                        }}</span>
                    </p>
                </div>
                <div
                ...
                >
                    <p class="mb-2 font-semibold">
                        {{ t('siteIntel.seoAudit.sitemapAuditTitle') }}
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.sitemapSampled') }}:
                        <span class="text-muted-foreground">{{
                            result.sitemapAudit.sampled
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.sitemapNon200') }}:
                        <span class="text-muted-foreground">{{
                            result.sitemapAudit.non200.length
                        }}</span>
                    </p>
                </div>
            </div>
            ...
            <div class="grid gap-2 xl:grid-cols-3">
                ...
                >
                    <div class="mb-2 flex items-center gap-2">
                        <p class="font-semibold">
                            {{ t('siteIntel.seoAudit.contentQualityTitle') }}
                        </p>
                        <span class="group relative inline-flex">
                            <span
                                class="inline-flex h-5 w-5 cursor-help items-center justify-center rounded-full border border-border text-[11px] font-semibold text-muted-foreground"
                    ...
                    <p>
                        {{ t('siteIntel.seoAudit.wordCount') }}:
                        <span class="text-muted-foreground">{{
                            result.quality.content.wordCount
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.textHtmlRatio') }}:
                        <span class="text-muted-foreground"
                            >{{ result.quality.content.textToHtmlRatio }}%</span
                        >
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.thinContent') }}:
                        <span class="text-muted-foreground">{{
                            result.quality.content.thinContent
                                ? t('siteIntel.common.yes')
                                : t('siteIntel.common.no')
                        }}</span>
                    </p>
                ...
                >
                    <div class="mb-2 flex items-center gap-2">
                        <p class="font-semibold">
                            {{ t('siteIntel.seoAudit.accessibilityTitle') }}
                        </p>
                        <span class="group relative inline-flex">
                            <span
                                class="inline-flex h-5 w-5 cursor-help items-center justify-center rounded-full border border-border text-[11px] font-semibold text-muted-foreground"
                    ...
                    <p>
                        {{ t('siteIntel.seoAudit.imagesWithoutAlt') }}:
                        <span class="text-muted-foreground"
                            >{{
                                result.quality.accessibility.imagesWithoutAlt
                            }}/{{
                                result.quality.accessibility.imagesTotal
                            }}</span
                        >
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.headingOrderBroken') }}:
                        <span class="text-muted-foreground">{{
                            result.quality.accessibility.headingOrderBroken
                                ? t('siteIntel.common.yes')
                                : t('siteIntel.common.no')
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.htmlIssues') }}:
                        <span class="text-muted-foreground">{{
                            result.quality.htmlValidation.issueCount
                        }}</span>
                    </p>
                </div>
                <div
                ...
                >
                    <div class="mb-2 flex items-center gap-2">
                        <p class="font-semibold">
                            {{ t('siteIntel.seoAudit.linkGraphTitle') }}
                        </p>
                        <span class="group relative inline-flex">
                            <span
                                class="inline-flex h-5 w-5 cursor-help items-center justify-center rounded-full border border-border text-[11px] font-semibold text-muted-foreground"
                    ...
                    <p>
                        {{ t('siteIntel.seoAudit.internalOutlinks') }}:
                        <span class="text-muted-foreground">{{
                            result.quality.linkGraph.internalOutlinks
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.externalOutlinks') }}:
                        <span class="text-muted-foreground">{{
                            result.quality.linkGraph.externalOutlinks
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.orphanRisk') }}:
                        <span class="text-muted-foreground">{{
                            result.quality.linkGraph.orphanRisk
                                ? t('siteIntel.common.yes')
                                : t('siteIntel.common.no')
                        }}</span>
                    </p>
            ...
            <div class="grid gap-2 xl:grid-cols-2">
                ...
                >
                    <div class="mb-2 flex items-center gap-2">
                        <p class="font-semibold">
                            {{ t('siteIntel.seoAudit.internationalTitle') }}
                        </p>
                        <span class="group relative inline-flex">
                            <span
                                class="inline-flex h-5 w-5 cursor-help items-center justify-center rounded-full border border-border text-[11px] font-semibold text-muted-foreground"
                    ...
                    <p>
                        {{ t('siteIntel.seoAudit.hreflangPages') }}:
                        <span class="text-muted-foreground">{{
                            result.international.pagesWithHreflang
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.hreflangMissingXDefault') }}:
                        <span class="text-muted-foreground">{{
                            result.international.missingXDefault.length
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.hreflangMissingReciprocal') }}:
                        <span class="text-muted-foreground">{{
                            result.international.missingReciprocal.length
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.hreflangClusters') }}:
                        <span class="text-muted-foreground">{{
                            result.international.clusters.length
                        }}</span>
                    </p>
                </div>
                <div
                ...
                >
                    ...
                    <p>
                        {{ t('siteIntel.seoAudit.crawlBudgetSource') }}:
                        <span class="text-muted-foreground">{{
                            result.crawlBudget.source
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.crawlBudgetBotHits') }}:
                        <span class="text-muted-foreground">{{
                            result.crawlBudget.botHits
                        }}</span>
                    </p>
                    <p>
                        {{ t('siteIntel.seoAudit.statusBuckets') }}:
                        <span class="text-muted-foreground"
                            ...
                            }}/{{ result.crawlBudget.statusBuckets['4xx'] }}/{{
                                result.crawlBudget.statusBuckets['5xx']
                            }}</span
                        >
                    </p>
                </div>
            ...
            <div class="space-y-2">
                ...
                <div class="flex flex-wrap gap-3 text-xs text-muted-foreground">
                    <label class="inline-flex items-center gap-2">
                        ...
                        <select
                            v-model="linkGraphFilters.mode"
                            class="h-7 rounded border border-input bg-background px-2 text-xs"
                        >
                            <option value="all">
                                {{ t('siteIntel.seoAudit.filterModeAll') }}
                            </option>
                            <option value="any">
                                {{ t('siteIntel.seoAudit.filterModeAny') }}
                            </option>
                        </select>
                    </label>
                    <label class="inline-flex items-center gap-2">
                        <input
                            v-model="linkGraphFilters.non200Only"
                            type="checkbox"
                            class="h-4 w-4"
                        />
                        <span>{{
                            t('siteIntel.seoAudit.filterNon200Only')
                        }}</span>
                    </label>
                    <label class="inline-flex items-center gap-2">
                        <input
                            v-model="linkGraphFilters.noindexOnly"
                            type="checkbox"
                            class="h-4 w-4"
                        />
                        <span>{{
                            t('siteIntel.seoAudit.filterNoindexOnly')
                        }}</span>
                    </label>
                    <label class="inline-flex items-center gap-2">
                        <input
                            v-model="linkGraphFilters.orphanRiskOnly"
                            type="checkbox"
                            class="h-4 w-4"
                        />
                        <span>{{
                            t('siteIntel.seoAudit.filterOrphanOnly')
                        }}</span>
                    </label>
                </div>
                <SeoAuditLinkGraph
