        ...
        <template #fields>
            ...
            >
                ...
                <label class="block min-w-0">
                    <span
                        class="mb-1 block truncate text-xs font-medium text-muted-foreground"
                        >{{ t('youtube.search.channelFilter') }}</span
                    >
                    <input
                ...
                >
                    <div class="flex gap-3">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            >
                                <span
                                    >{{ t('youtube.analytics.metrics.views') }}:
                                    {{ fmt(video.views) }}</span
                                >
                                <span
                                    >{{ t('youtube.analytics.metrics.likes') }}:
                                    {{ fmt(video.likes) }}</span
                                >
                                <span
                                    >{{
                                        t('youtube.analytics.metrics.comments')
                            ...
                            >
                                <p
                                    v-if="ensureCommentState(video.id).loading"
