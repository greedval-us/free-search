            ...
            <div class="space-y-1">
                <div class="flex items-center gap-2 text-sm font-semibold">
                    ...
                    <HelpTooltip
                        ...
                        :text="t('youtube.parser.help.overview')"
                    />
                </div>
                <p class="text-xs text-muted-foreground">
                    {{
                        settingsCollapsed
                            ? t('youtube.parser.collapsed')
                            : t('youtube.parser.subtitle')
                    }}
                </p>
            </div>
        ...
        <div v-if="!settingsCollapsed" class="mt-3 space-y-3">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                >
                    ...
                    {{
                        loading
                            ? t('youtube.parser.collecting')
                            : t('youtube.parser.start')
                    }}
                </button>
    ...
    <section class="intel-panel-strong">
        <div class="flex items-center justify-between gap-3">
            <h3 class="text-sm font-semibold">
                {{ t('youtube.parser.progress.title') }}
            </h3>
            <span
        ...
        <div class="mt-3 grid gap-3 md:grid-cols-2">
            ...
            >
                <p class="text-xs text-muted-foreground">
                    {{ t('youtube.parser.progress.comments') }}
                </p>
            ...
            >
                <p class="text-xs text-muted-foreground">
                    {{ t('youtube.parser.progress.replies') }}
                </p>
