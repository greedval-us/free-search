...
const HandlerController = (
    args:
        | { resourceUri: string | number; handlerUri: string | number }
        | [resourceUri: string | number, handlerUri: string | number],
...
HandlerController.url = (
    ...
    return (
        HandlerController.definition.url
