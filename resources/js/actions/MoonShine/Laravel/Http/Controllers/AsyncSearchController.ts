...
AsyncSearchController.url = (
    ...
    return (
        AsyncSearchController.definition.url
 ...
 * @route '/admin/async-search/{pageUri}/{resourceUri?}/{resourceItem?}'
 */
const AsyncSearchControllerForm = (
    args:
        | {
              pageUri: string | number;
              resourceUri?: string | number;
 ...
 * @route '/admin/async-search/{pageUri}/{resourceUri?}/{resourceItem?}'
 */
AsyncSearchControllerForm.head = (
    args:
        | {
              pageUri: string | number;
              resourceUri?: string | number;
