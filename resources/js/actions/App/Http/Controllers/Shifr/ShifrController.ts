 ...
 * @see app/Http/Controllers/Shifr/ShifrController.php:22
 * @route '/shifr/hash'
 */
 ...
 * @see app/Http/Controllers/Shifr/ShifrController.php:31
...
const ShifrController = { hash, transform, extractIocs, classic }
