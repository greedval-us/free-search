...
/**
* @see \App\Http\Controllers\Mastodon\MastodonParserController::start
 * @see app/Http/Controllers/Mastodon/MastodonParserController.php:29
 * @route '/mastodon/parser/start'
 */
...
/**
* @see \App\Http\Controllers\Mastodon\MastodonParserController::status
 * @see app/Http/Controllers/Mastodon/MastodonParserController.php:34
 * @route '/mastodon/parser/status/{runId}'
 */
...
status.definition = {
    methods: ["get","head"],
    url: '/mastodon/parser/status/{runId}',
...
/**
* @see \App\Http\Controllers\Mastodon\MastodonParserController::stop
 * @see app/Http/Controllers/Mastodon/MastodonParserController.php:41
 * @route '/mastodon/parser/stop/{runId}'
 */
...
stop.definition = {
    methods: ["post"],
    url: '/mastodon/parser/stop/{runId}',
} satisfies RouteDefinition<["post"]>
 ...
 */
    ...
    stop.form = stopForm
/**
* @see \App\Http\Controllers\Mastodon\MastodonParserController::history
 * @see app/Http/Controllers/Mastodon/MastodonParserController.php:48
 * @route '/mastodon/parser/history'
 */
...
/**
* @see \App\Http\Controllers\Mastodon\MastodonParserController::downloadExcel
 * @see app/Http/Controllers/Mastodon/MastodonParserController.php:57
 * @route '/mastodon/parser/download-excel/{runId}'
 */
...
downloadExcel.definition = {
    methods: ["get","head"],
    url: '/mastodon/parser/download-excel/{runId}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @see app/Http/Controllers/Mastodon/MastodonParserController.php:71
...
downloadJson.definition = {
    methods: ["get","head"],
    url: '/mastodon/parser/download-json/{runId}',
} satisfies RouteDefinition<["get","head"]>
...
const MastodonParserController = { start, status, stop, history, downloadExcel, downloadJson }

export default MastodonParserController