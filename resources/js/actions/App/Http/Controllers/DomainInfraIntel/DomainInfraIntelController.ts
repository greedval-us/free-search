...
/**
 * @see \App\Http\Controllers\DomainInfraIntel\DomainInfraIntelController::lookup
 * @see app/Http/Controllers/DomainInfraIntel/DomainInfraIntelController.php:17
 * @route '/domain-infra-intel/lookup'
 */
export const lookup = (
...
const DomainInfraIntelController = { lookup };

export default DomainInfraIntelController;
