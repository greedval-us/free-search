 ...
 * @see app/Http/Controllers/Bluesky/BlueskyAnalyticsController.php:23
 * @route '/bluesky/analytics/summary'
 */
...
/**
* @see \App\Http\Controllers\Bluesky\BlueskyAnalyticsController::report
 * @see app/Http/Controllers/Bluesky/BlueskyAnalyticsController.php:32
 * @route '/bluesky/analytics/report'
 */
...
const BlueskyAnalyticsController = { summary, report }

export default BlueskyAnalyticsController