 ...
 */
    ...
    stop.form = stopForm
/**
* @see \App\Http\Controllers\Bluesky\BlueskyParserController::history
 * @see app/Http/Controllers/Bluesky/BlueskyParserController.php:48
 * @route '/bluesky/parser/history'
 */
 ...
 * @see app/Http/Controllers/Bluesky/BlueskyParserController.php:57
...
const BlueskyParserController = { start, status, stop, history, downloadExcel, downloadJson }
