 ...
 * @route '/gdelt'
 */
export const gdelt = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: gdelt.url(options),
    method: 'get',
})
 ...
 * @route '/gdelt'
 */
gdelt.url = (options?: RouteQueryOptions) => {
    return gdelt.definition.url + queryParams(options)
}
 ...
 * @route '/gdelt'
 */
gdelt.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: gdelt.url(options),
    method: 'get',
})
/**
 ...
 * @route '/gdelt'
 */
gdelt.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: gdelt.url(options),
    method: 'head',
})
 ...
 * @route '/gdelt'
 */
    const gdeltForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: gdelt.url(options),
        method: 'get',
    })
 ...
 * @route '/gdelt'
 */
        gdeltForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: gdelt.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/gdelt'
 */
        gdeltForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: gdelt.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
