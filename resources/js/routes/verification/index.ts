 ...
 * @route '/localhost/email/verify/{id}/{hash}'
 */
...
verify.definition = {
    methods: ["get","head"],
    url: '/localhost/email/verify/{id}/{hash}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/localhost/email/verification-notification'
 */
...
send.definition = {
    methods: ["post"],
    url: '/localhost/email/verification-notification',
