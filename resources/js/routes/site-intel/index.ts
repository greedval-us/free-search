 ...
 * @see app/Http/Controllers/SiteIntel/SiteIntelController.php:40
 * @route '/site-intel/domain-lite'
 */
export const domainLite = (
    options?: RouteQueryOptions
): RouteDefinition<'get'> => ({
 ...
 * @see app/Http/Controllers/SiteIntel/SiteIntelController.php:52
 ...
 * @see app/Http/Controllers/SiteIntel/SiteIntelController.php:66
 ...
 * @see app/Http/Controllers/SiteIntel/SiteIntelController.php:78
 ...
 * @see app/Http/Controllers/SiteIntel/SiteIntelController.php:95
...
const siteIntel = {
    ...
    seoReport: Object.assign(seoReport, seoReport),
