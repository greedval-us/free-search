...
throughRelation.url = (
    ...
    return (
        throughRelation.definition.url
            .replace('{resourceUri}', parsedArgs.resourceUri.toString())
...
const updateField = {
    throughColumn: Object.assign(throughColumn, throughColumn),
    throughRelation: Object.assign(throughRelation, throughRelation),
};
