...
export const component = (
    args:
        | { pageUri: string | number; resourceUri?: string | number }
        | [pageUri: string | number, resourceUri: string | number],
    options?: RouteQueryOptions
): RouteDefinition<'get'> => ({
...
component.url = (
    ...
    validateParameters(args, ['resourceUri']);
