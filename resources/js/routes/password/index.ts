 ...
 * @route '/localhost/forgot-password'
 */
 ...
 * @route '/localhost/reset-password/{token}'
 */
...
reset.definition = {
    methods: ["get","head"],
    url: '/localhost/reset-password/{token}',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/localhost/reset-password'
 */
 ...
 * @route '/localhost/user/confirm-password'
 */
...
confirm.definition = {
    methods: ["get","head"],
    url: '/localhost/user/confirm-password',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/localhost/user/confirmed-password-status'
 */
...
confirmation.definition = {
    methods: ["get","head"],
    url: '/localhost/user/confirmed-password-status',
} satisfies RouteDefinition<["get","head"]>
