...
class TelegramAnalyticsQueryService
{
     ...
     */
    public function buildSummary(array $params, Carbon $from, Carbon $to, ?string $snapshotRole = null): array
    {
     ...
     */
    public function buildReport(array $params, Carbon $from, Carbon $to): array
    {
     ...
     * @return array<string, mixed>
     */
    private function loadCachedAnalytics(array $params, Carbon $from, Carbon $to): array
    {
     ...
     */
    private function storeSummarySnapshot(array $params, Carbon $from, Carbon $to, array $data): void
    {
     ...
     * @param array{chatUsername: string, scorePriority: string, keyword: ?string} $params
     */
    private function analyticsCacheKey(array $params, Carbon $from, Carbon $to): string
    {
