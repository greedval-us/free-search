...
return [
    ...
    'api' => [
        'report_expired' => 'Отчёт недоступен или срок его хранения истёк. Запустите анализ заново.',
        ...
        'parser_run' => [
            'not_found' => 'Запуск парсера не найден или срок его хранения истёк.',
            'not_downloadable' => 'Результат парсера ещё не готов к скачиванию.',
            'result_not_found' => 'Файл результата парсера не найден или срок его хранения истёк.',
        ],
        'site_intel' => [
